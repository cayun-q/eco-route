...
function makeStyles(colors: ThemeColors) {
  ...
  return StyleSheet.create({
    ...
    chip: { borderRadius: radius.chip, borderWidth: 1, paddingVertical: 10, paddingHorizontal: 16, minHeight: 40, justifyContent: "center" },
    chipIdle: { backgroundColor: colors.surfaceMuted, borderColor: colors.line },
    chipDisabled: { opacity: 0.38 },
    chipLabel: { fontFamily: font.bodyMed, fontSize: 14 },
    ...
    field: { gap: space.xs },
    fieldLabel: { fontFamily: font.bodyMed, fontSize: 13, color: colors.muted, textTransform: "uppercase", letterSpacing: 0.6 },
    input: { borderWidth: 1, borderColor: colors.line, backgroundColor: colors.surface, color: colors.ink, borderRadius: radius.card, paddingHorizontal: space.md, paddingVertical: 12, fontFamily: font.body, fontSize: 16 },
