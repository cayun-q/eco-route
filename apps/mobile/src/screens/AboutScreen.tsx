    ...
    <Screen>
      <ScrollView contentContainerStyle={styles.wrap}>
        ...
        <View style={styles.copyCard}>
          ...
          <Text style={styles.body}>Luma compares real road routing with flight itineraries and turns each route into an estimated CO₂e total. Automatic mode can build an itinerary for you, while Manual mode lets you enter the trip you already have planned.</Text>
          <Text style={styles.body}>The goal is not to tell you where you can or cannot go. It is to make the environmental cost of a trip easier to see before or after you travel.</Text>
        </View>
      </ScrollView>
    </Screen>
  );
